...
<body class="dark:bg-slate-900 dark:text-white">
    <main class="max-w-[1440px] mx-auto overflow-hidden relative">
        ...
        <header class="bg-[#F4F6F6] dark:bg-slate-950 dark:text-white text-black px-5 py-5">
                ...
                <div class="">
                    <div class="">
                        <form action="" method="post">
                            <input type="search" name="" id="" class="w-[550px] h-[2rem] text-black border border-[#CCD1D1] rounded-full outline-none text-[1rem] px-2">

        ...
        <div class=" w-full">
            ...
            <form action="#" method="post">
                <div class="space-y-5">
                    ...
                    <div class="">
                        <input id="password" required class="w-full py-2 px-1 outline-none text-black rounded-lg border border-[#CACFD2]" type="password" placeholder="Contraseña" name="" id="">
                    </div>
